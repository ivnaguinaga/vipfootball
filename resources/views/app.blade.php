        ...
        <header class="fixed top-0 left-0 right-0 z-50 bg-gray-800/80 backdrop-blur-md border-b border-gray-700 shadow-xl">
            <div class="max-w-full px-6">
                <div class="flex items-center h-20">
                    <!-- Logo - Left -->
                    <a href="/" class="flex items-center gap-3 hover:opacity-80 transition-opacity mr-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="220" height="64" viewBox="0 0 220 64" role="img" aria-label="VipFootball logo" class="h-16">
                          <defs>
                    ...
                    <!-- Navigation - Center -->
                    <nav class="absolute left-1/2 transform -translate-x-1/2 flex items-center gap-2">
                    ...
                    <a href="/contact" class="ml-auto px-6 py-2.5 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white rounded-lg transition-all font-semibold shadow-lg shadow-emerald-600/30 hover:shadow-emerald-600/50 hover:scale-105 transform">
                        Contact Me
                    </a>
                </div>
            </div>
